...
export class SetToken extends StoreParameterCommand {
  ...
  static description =
    'sets given value as token. Will check available tickers if given value is possible. Will automatically ' +
    Commands.Skip +
    ' one execution of your vault-maxi.\n' +
    'example: ' +
    ...
    '!------------------!\n' +
    'this is only supposed to be called on failsafe bot instances, if you have called ' +
    Commands.ChangeTokenTo +
    ' on your main vault-maxi.'
