...
export class ChangeTokenTo extends StoreParameterCommand {
  ...
  static description =
    'changes your vault-maxi to use a new token. This will automatically trigger a set of steps:\n' +
    ...
    "CAREFUL: don't forget to execute " +
    Commands.SetToken +
    ' on any failsafe bot instances.\n' +
    'example: ' +
  ...
  successMessage(): string | undefined {
    return (
      "Your vault-maxis' token is set to " +
      this.token +
